...
//Shows the reset password route

router.get("/forgot", function(req, res){
    res.render("forgot")
})

//Rest password post route
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      var smtpTransport = nodemailer.createTransport({
        service: 'Gmail', 
        auth: {
          user: 'yelpcampmichalak@gmail.com',
          pass: process.env.GMAILPW
        }
      });
      var mailOptions = {
        to: user.email,
        from: 'yelpcampmichalak@gmail.com',
